		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#sapktcaseprojectcasestudyproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapktcaseprojectcasestudyproject-display": {
								"semanticObject": "sapktcaseprojectcasestudyproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.kt.caseproject.casestudyproject",
									"url": sap.ui.require.toUrl("sap/kt/caseproject/casestudyproject")
								}
							}
						}
					}
